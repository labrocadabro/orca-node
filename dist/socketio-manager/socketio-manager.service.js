...
exports.SocketioManagerService = exports.configValues = exports.podIdList = exports.DB = exports.ConnectionType = void 0;
...
function authentication_middleware(socket, next) {
    ...
    exports.podIdList = exports.podIdList.filter((item, index) => exports.podIdList.indexOf(item) === index);
...
let SocketioManagerService = class SocketioManagerService {
    ...
    initialize() {
        ...
        httpServer.listen(this.port, this.host, () => {
            this.logger.log(`Server started on port ${this.port} and host ${this.host}`);
        });
    ...
    _initialize_listeners() {
        this.socketServer.on('connection', (socket) => {
            ...
            (0, socketio_handlers_1.registerPodLifecycleHandlers)(this.socketServer, socket, this.pulseProxyPort, this.cmClient, this.logger);
            (0, socketio_handlers_1.registerPulseProxyHandlers)(this.socketServer, socket, this.logger);
