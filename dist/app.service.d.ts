...
export default class Orca {
    ...
    constructor(socketIOManager: SocketioManagerService, metricsService: MetricsService, logger: LoggerService, winInstaller: WinInstaller, macInstaller: MacOSInstaller, configService: ConfigService);
